# inventory_management_system/settings.py
"""
...
SECRET_KEY = "django-insecure-5zyjz1(w1(g2nw=hch!pxboa8xwm4*v!b+*dm$nd#oc3=v77)&"
...
INSTALLED_APPS = [
    ...
    # ✅ Your Django app (use AppConfig so signals load)
